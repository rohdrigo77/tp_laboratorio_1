...
int parser_EmployeeFromText(FILE* pArchivo , LinkedList* pArrayListEmployee)
{
	...
	{
		printf("Entre al primer if de parser \n");
		...
		do
		{
			...
			printf("Termine de crear el empleado \n");
			if (pEmpleado != NULL)
			{
				printf("Antes de usar ll_add \n");
				ll_add(pArrayListEmployee, pEmpleado);
				printf("Despues de usar ll_add \n");
				estado = 1;
			}
			else
			{
